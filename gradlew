...
if $cygwin || $msys ; then
    ...
    # TODO: if we add a pattern for the drive letter to ROOTDIRS, we might fix the conversion of drive letters
    # However, it is not easy because we need to add the drive letter to the patterns.
    # For now just assume C:
